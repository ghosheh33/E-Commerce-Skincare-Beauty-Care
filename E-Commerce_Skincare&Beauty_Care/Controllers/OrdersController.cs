...
namespace E_Commerce_Skincare_Beauty_Care.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TotalAmount,State,PaymentMethod,OrderDate,UserId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TotalAmount,State,PaymentMethod,OrderDate,UserId")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
